...
import { ElevationScrollProps } from 'ui-component/extended/AppBar';
...
// sticky details card
export interface EScrollProps extends ElevationScrollProps {}

function ElevationScroll(props: EScrollProps) {
