...
const filter: (options: FilmFilter[], state: FilterOptionsState<FilmFilter>) => FilmFilter[] = createFilterOptions();
...
const FrmAutocomplete = () => {
    const [valueControl, setValueControl] = React.useState<FilmFilter | null | undefined>(null);
    const [value, setValue] = React.useState<string>(options[0]);
    const [inputValue, setInputValue] = React.useState<string>('');
    const [value2, setValue2] = React.useState<string | FilmFilter | null | undefined>(options[0]);
                        ...
                        <Grid container direction="column" spacing={2}>
                            ...
                            <Grid item xs={12}>
                                <Autocomplete
                                    ...
                                    id="controlled-demo"
                                    value={valueControl}
                                    onChange={(event, newValue: FilmFilter | null | undefined) => {
